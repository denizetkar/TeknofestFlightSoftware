...
void MadgwickAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az, float deltat) {
  ...
  if(!((ax == 0.0) && (ay == 0.0) && (az == 0.0))) {
    ...
    // Gradient decent algorithm corrective step
    s_a[0] = _4q0 * q2q2 + _2q2 * ax + _4q0 * q1q1 - _2q1 * ay;
    s_a[1] = _4q1 * q3q3 - _2q3 * ax + 4.0 * q0q0 * q_a[1] - _2q0 * ay - _4q1 + _8q1 * q1q1 + _8q1 * q2q2 + _4q1 * az;
    s_a[2] = 4.0 * q0q0 * q_a[2] + _2q0 * ax + _4q2 * q3q3 - _2q3 * ay - _4q2 + _8q2 * q1q1 + _8q2 * q2q2 + _4q2 * az;
    s_a[3] = 4.0 * q1q1 * q_a[3] - _2q1 * ax + 4.0 * q2q2 * q_a[3] - _2q2 * ay;
    recipNorm = 1.0 / sqrt(s_a[0] * s_a[0] + s_a[1] * s_a[1] + s_a[2] * s_a[2] + s_a[3] * s_a[3]);
    // normalise step magnitude
